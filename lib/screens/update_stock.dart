...
class _update_stockState extends State<update_stock> {
  ...
  updateStock(String stock_id, String cost_price, String selling_price,
    ...
    var jsonData;
    var response =
        await http.post(Constants.domain + "updateStock", body: data, headers: {
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              const ListTile(
                                ...
                                title: Text("KAKU"),
                                subtitle: Text(
                                    'Update a previously added stock by simply updating these fields'),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(18.0),
                                child: TextFormField(
                                  initialValue: widget.stock_id,
                                  onFieldSubmitted: (v) {
                                    FocusScope.of(context).requestFocus(focus1);
                                  },
                                  onSaved: (String value) {
                                    stockId = widget.stock_id;
                                  },
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  controller: _costPriceController..text = widget.cost_price,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  controller: _sellingPriceController..text = widget.selling_price,
                                   textInputAction: TextInputAction.next,
                                  onFieldSubmitted: (v) {
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  controller: _quantityController..text = widget.quantity,
                                   textInputAction: TextInputAction.next,
                                  keyboardType: TextInputType.number,
                                  onFieldSubmitted: (v) {
...
//                                  validator: _validateConfirmPassword,
                                  controller: _discountController..text = widget.discount,
                                      textInputAction: TextInputAction.next,
                                  onFieldSubmitted: (v) {
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  controller: _descriptionController..text = widget.description,
